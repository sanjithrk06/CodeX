    ...
    <>
        ...
        <div className="px-3 py-5 lg:px-5 lg:pl-3">
            ...
            <div className="flex items-center justify-start rtl:justify-end">
                ...
                <Link to={'/c'} className="flex ms-2 md:me-24">
        ...
        <div className="h-full px-2 pb-4 overflow-y-auto bg-white dark:bg-primary">
            <ul className="space-y-2 mt-2 font-medium">
                ...
                <NavLink 
                    to={'/c'} 
                    className={({ isActive }) => 
                    `inline-block items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-transparent dark:hover:bg-transparent dark:hover:ring-2 dark:hover:ring-gray-700 group ${isActive ? 'ring-2 ring-gray-700' : ''}`
                    }
                >
