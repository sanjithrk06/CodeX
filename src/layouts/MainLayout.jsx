...
const MainLayout = () => {
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <NavLink to={"/c"} className="flex ms-2">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-[#6b7280]">
                  CodeX
                </span>
              </NavLink>
            </div>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-16 h-screen pt-20 transition-transform -translate-x-full border-r sm:translate-x-0 bg-primary border-tertiary-bdr"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 mt-2 font-medium">
            <li>
              <NavLink
                to={"/c"}
                className={({ isActive }) =>
                  `inline-block items-center p-2 rounded-lg hover:bg-transparent hover:ring-2 hover:ring-tertiary-btn group ${
                    isActive ? "ring-2 ring-tertiary-btn" : ""
                  }`
                }
              >
                <svg
                  className="w-8 h-8 transition duration-75"
                  viewBox="0 0 128 128"
                >
                  <path
                    fill="#0ea5e9"
