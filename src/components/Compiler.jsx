...
const Compiler = () => {
  ...
  useEffect(() => {
    if (isTestCase) {
      setTestCasePanelSize({ minSize: 25, defaultSize: 30, maxSize: 50 }); // Adjust these sizes as needed
    } else {
      ...
      <PanelGroup autoSaveId="persistence" direction="horizontal" className='h-[90vh]'>
        ...
        <Panel minSize={25} order={2} className='h-[90vh]'>
          <PanelGroup direction="vertical">
            ...
            <Panel minSize={testCasePanelSize.minSize} order={2} maxSize={testCasePanelSize.maxSize} defaultSize={testCasePanelSize.defaultSize}>
              <div>
